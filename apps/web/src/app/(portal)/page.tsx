...
export default function HomePage() {
  ...
  if (isLoading) {
    return <div className="min-h-screen bg-n-bg" />;
  }
      ...
      <div className="min-h-screen bg-n-bg animate-fade-in">
        ...
        <div className="relative -mt-20 z-10 px-4 md:px-12 mb-6">
          <div className="bg-[#181818]/70 border border-white/10 backdrop-blur-md rounded-2xl p-5 md:p-6 shadow-2xl flex items-center justify-between">
            ...
            <div className="hidden sm:flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-red-500/10 border border-red-500/20 text-red-500 text-xs font-semibold">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center z-20 px-4 text-center mt-12 bg-black/40">
          ...
          >
            ...
            <form onSubmit={handleGetStarted} className="flex flex-col sm:flex-row gap-3 max-w-xl mx-auto pt-2">
              ...
              <button
                type="submit"
                className="px-8 py-4 bg-n-red hover:bg-n-red-hover text-white font-bold rounded-xl flex items-center justify-center gap-2 transition-all hover:scale-105 active:scale-95 shadow-lg shadow-red-500/25"
              >
                Get Started
            ...
            {[
              ...
              <div
                ...
                className={`relative flex flex-col rounded-3xl border p-6 ${
                  p.popular 
                    ? 'border-n-red bg-gradient-to-b from-n-red/10 to-[#121212] scale-[1.03] shadow-lg shadow-red-500/10' 
