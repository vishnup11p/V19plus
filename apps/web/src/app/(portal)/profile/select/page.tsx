                ...
                {[0, 1, 2, 3].map((idx) => (
                  <div
                    ...
                    className={`w-4 h-4 rounded-full border-2 transition-all ${
                      pinCode.length > idx
                        ? 'bg-n-red border-n-red scale-110 shadow-lg shadow-orange-500/30'
            ...
            >
              ...
              <div className="flex gap-3 pt-2">
                <button
                  ...
                  className="flex-1 py-3.5 bg-white/5 hover:bg-white/10 text-white font-semibold rounded-xl text-sm transition-all"
                >
                  Cancel
                </button>
                <button
                  ...
                  className="flex-[2] py-3.5 bg-n-red hover:bg-n-red-hover text-white font-bold rounded-xl text-sm flex items-center justify-center gap-1.5 transition-all disabled:opacity-50 hover:scale-102"
                >
                  Create Profile
                </button>
              </div>
