          ...
          >
            <div className="text-center space-y-6">
              ...
              <div className="relative w-24 h-24 mx-auto flex items-center justify-center">
                ...
                />
                <div className="w-16 h-16 rounded-full bg-n-red border border-red-500/50 flex items-center justify-center text-white relative z-10 shadow-lg shadow-red-500/40">
