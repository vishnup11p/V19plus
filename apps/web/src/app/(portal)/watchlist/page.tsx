    ...
    <div className="min-h-screen bg-n-bg pt-24 pb-16 animate-fade-in animate-fade-up">
      ...
      <div className="px-4 md:px-12">
        {items.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center py-20 text-center bg-white/5 border border-white/10 rounded-2xl p-8 max-w-lg mx-auto shadow-xl backdrop-blur-md">
            <div className="w-16 h-16 rounded-2xl bg-n-red/10 border border-n-red/20 flex items-center justify-center text-3xl mb-6 text-n-red animate-pulse">
              🎬
            </div>
            ...
            <button
              onClick={() => router.push('/')}
              className="px-6 py-3 bg-n-red hover:bg-n-red-hover text-white font-bold rounded-md transition-all active:scale-95 text-sm shadow-md shadow-red-950/20 hover:shadow-lg hover:shadow-red-500/25"
            >
              Start Exploring
            </button>
          </div>
