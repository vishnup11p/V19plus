...
export function HeroBanner({ content, isLoading }: HeroBannerProps) {
  ...
  return (
    <section className="relative h-[60vh] sm:h-[70vh] md:h-[80vh] min-h-[400px] sm:min-h-[560px] max-h-[900px] overflow-hidden bg-n-black">
      {/* Backdrop */}
      ...
      <motion.div
        ...
        className="relative z-10 flex flex-col justify-end h-full px-4 sm:px-6 md:px-16 pb-16 sm:pb-20 md:pb-28 max-w-2xl"
      >
        {/* Originals badge */}
        {content.isOriginal && (
          <motion.div
        ...
        <motion.h1
          ...
          className="text-3xl sm:text-5xl md:text-7xl font-black leading-none text-shadow mb-3 sm:mb-4"
        >
          {content.title}
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-xs sm:text-sm md:text-base text-n-text/80 mb-4 sm:mb-6 line-clamp-2 sm:line-clamp-3 max-w-xl text-shadow-sm"
        >
          {content.description}
        </motion.p>
        ...
        >
          <Link
            ...
            className="flex items-center gap-2 px-5 sm:px-7 py-2.5 sm:py-3 bg-n-white hover:bg-n-white/80 text-black font-bold rounded text-sm sm:text-base transition-all active:scale-95"
          >
          ...
          <Link
            ...
            className="flex items-center gap-2 px-5 sm:px-7 py-2.5 sm:py-3 bg-n-muted/40 hover:bg-n-muted/60 text-white font-semibold rounded text-sm sm:text-base backdrop-blur-sm border border-white/10 transition-all active:scale-95"
          >
